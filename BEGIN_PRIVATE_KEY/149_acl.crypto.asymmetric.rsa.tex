    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" role="search" aria-label="Site" data-scope-type="Repository" data-scope-id="2843993" data-scoped-search-url="/cforler/Ada-Crypto-Library/search" data-owner-scoped-search-url="/users/cforler/search" data-unscoped-search-url="/search" data-turbo="false" action="/cforler/Ada-Crypto-Library/search" accept-charset="UTF-8" method="get">
      <label class="form-control header-search-wrapper input-sm p-0 js-chromeless-input-container header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center">
        <input type="text"
          ...
          autocomplete="off"
        >
        <input type="hidden" value="jh3x1gvAtyl1guYhrJ4aRmX3z5K9Kz61KNUtBJslgmEdQfDpFLjkgKaEQTb_RatPNX_-Tk6BEzwi5dDrj7HgEg" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
